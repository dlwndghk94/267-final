# Visualizer adapted from https://github.com/KieranWynn/particle_filter_visualizer/blob/master/particle_filter_visualizer.py
...
class ParticleViewer:
	...
	def add_robot(self, x, y, radius=2.0, color='r'):
		r = pyplot.Circle((x, y), radius, color=color)
